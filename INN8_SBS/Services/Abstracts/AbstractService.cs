...
public abstract class AbstractService<UserRequestObject, RequestObject, ResponseObject> :
    AbstractRequestProcessor<ResponseObject, RequestObject>,
    IRestProperties<RequestObject, ResponseObject>,
    IProcess<RequestObject, ResponseObject>
  ...
  where UserRequestObject : RequestParametersBase
{
  ...
  public AbstractService(UserRequestObject @userobject)
  {
  ...
  public void Validate()
  {
    ...
    {
      //throw new INN8Exception("Error callerDetails_clientID not set.", null);
    }
  }
